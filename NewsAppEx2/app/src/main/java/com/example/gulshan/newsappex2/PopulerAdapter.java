...
public class PopulerAdapter  extends BaseAdapter {
    LayoutInflater inflater;
    LinearLayout show;
    PopulerFragment gActivity;
    List<Result> list;
    String url1=null,dis=null;
    TextView tv1,tv2;
    public PopulerAdapter(PopulerFragment gActivity, List<Result> list){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(gActivity.getActivity(),ShowActivity.class);
