...
public class BusinessFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.business_fragment_activity,container,false);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12//fetch_hindi_business.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_business.php";
                        }
    ...
    public void Startdataloading(){
        ...
        BusinessApi api = r.create(BusinessApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        BusinessAdapter(BusinessFragment.this,list1));
