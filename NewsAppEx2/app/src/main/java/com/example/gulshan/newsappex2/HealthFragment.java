...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.health_fragment_activity,container,false);
            ...
            public void onRefresh() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String url4 = "http://techzig.com/newsapp12/fetch_health.php";
                        pref=getContext().getSharedPreferences("LANGUAGE", Context.MODE_PRIVATE);
                        editor = pref.edit();

                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_health.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_health.php";
                        }
    ...
    public void Startdataloading(){
        ...
        HelthApi api = r.create(HelthApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        HelthAdapter(HealthFragment.this,list1));
