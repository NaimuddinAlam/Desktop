...
public class PopulerFragment  extends Fragment {
    ...
    private static final String TAG = "PopulerFragment";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.popukar_fragment_activity,container,false);
            ...
            public void onRefresh() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String url4 = "http://techzig.com/newsapp12/fetch__top.php";
                        pref=getContext().getSharedPreferences("LANGUAGE", Context.MODE_PRIVATE);
                        editor = pref.edit();

                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_top.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch__top.php";
                        }
    ...
    public void Startdataloading() {
        ...
        PopulerApi api = r.create(PopulerApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        PopulerAdapter(PopulerFragment.this, list1));
