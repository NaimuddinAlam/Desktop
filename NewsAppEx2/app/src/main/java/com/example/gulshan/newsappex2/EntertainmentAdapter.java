...
public class EntertainmentAdapter extends BaseAdapter {
    ...
    LinearLayout show;
    EntertainmentFragment eActivity;
    List<Result> list;
    String url1=null,dis=null;
    TextView tv1,tv2;
    public EntertainmentAdapter(EntertainmentFragment eActivity, List<Result> list){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(eActivity.getActivity(),ShowActivity.class);
