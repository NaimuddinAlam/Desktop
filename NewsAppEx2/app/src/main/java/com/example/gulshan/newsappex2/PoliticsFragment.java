...
public class PoliticsFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.politics_fragment_activity,container,false);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_poli.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_politics.php";
                        }
    ...
    public void Startdataloading(){
        ...
        PoliticsApi api = r.create(PoliticsApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        PoliticAdapter(PoliticsFragment.this,list1));
