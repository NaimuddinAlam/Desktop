...
public class FunFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fun_fragment_activity, container, false);
            ...
            public void onRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String url4 = "http://techzig.com/newsapp12/fetch_fun.php";
                        pref=getContext().getSharedPreferences("LANGUAGE", Context.MODE_PRIVATE);
                        editor = pref.edit();

                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_fun.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_fun.php";
                        }
    ...
    public void Startdataloading() {
        ...
        FunApi api = r.create(FunApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        FunAdapter(FunFragment.this, list1));
