...
public class CricketFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.cricket_fragment_activity,container,false);
    ...
    public void Startdataloading(){
        ...
        CricketApi api = r.create(CricketApi.class);
        call=api.getResults();
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                Log.w("cricktapi",new Gson().toJson(response));
                Results ar = response.body();
                List<Result> list1=ar.getResult();
                lView.setAdapter(new
                        CricketAdapter(CricketFragment.this,list1));
            }
            @Override
  ...
  public  interface CricketApi{
      @GET("newsapp12/fetch_json_cricket.php")
    ...
    new Thread(new Runnable() {
        ...
        public void run() {
            ...
            if(pref.getBoolean("lvalue", false)){
                url4 = "http://techzig.com/newsapp12/fetch_hindi_cricket.php";
            }
            else {
                url4 = "http://techzig.com/newsapp12/fetch_cricket.php";
            }
