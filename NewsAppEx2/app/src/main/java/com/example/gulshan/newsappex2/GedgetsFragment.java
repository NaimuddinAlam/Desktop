...
public class GedgetsFragment  extends Fragment {
    ListView lView;
    public  SharedPreferences pref;
    public   SharedPreferences.Editor editor;

    SwipeRefreshLayout swiperefresh;
    private static final String TAG = "GedgetsFragment";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gadgets_fragment_activity,container,false);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_tech.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_techo.php";
                        }
    ...
    public void Startdataloading(){
        ...
        GedgetsApi api = r.create(GedgetsApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        GedgetsAdapter(GedgetsFragment.this,list1));
