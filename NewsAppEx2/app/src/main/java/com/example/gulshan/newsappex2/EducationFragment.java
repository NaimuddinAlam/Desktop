...
public class EducationFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.education_fragment_activity,container,false);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_edu.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_edu.php";
                        }
    ...
    public void Startdataloading(){
        ...
        EducationApi api = r.create(EducationApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        EducationAdapter(EducationFragment.this,list1));
