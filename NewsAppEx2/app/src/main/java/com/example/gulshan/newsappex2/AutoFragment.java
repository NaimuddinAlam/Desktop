...
public class AutoFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.auto_fragment_activity,container,false);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(pref.getBoolean("lvalue", false)){
                            url4 = "http://techzig.com/newsapp12/fetch_hindi_moto.php";
                        }
                        else {
                            url4 = "http://techzig.com/newsapp12/fetch_moto.php";
                        }
    ...
    public void Startdataloading(){
        ...
        AutoApi api = r.create(AutoApi.class);
        ...
        call.enqueue(new Callback<Results>() {
            ...
            public void onResponse(Call<Results> call, Response<Results> response) {
                ...
                lView.setAdapter(new
                        AutoAdapter(AutoFragment.this,list1));
